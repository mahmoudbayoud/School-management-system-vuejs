      ...
      <div v-if="selectedTab === 'sb'" class="pa-4" dir="rtl">
        <v-container>
          ...
          <v-row style="margin-top: 24px">
            <v-col cols="7" style="display: flex; justify-content: center">
              <v-select
...
export default {
  ...
  data() {
    return {
      ...
      gender: [
        { id: 1, name: "ذكر", value: "Male" },
        { id: 2, name: "انثى", value: "Female" },
      ],
      grades: [
  ...
  methods: {
    ...
    async submitForm() {
      ...
      console.log(payload);
      await this.sendData("/teachers/store", payload);
      ...
      this.$router.push({
        ...
        query: {
          ...
          divison_name: selecteddivisonName,
        },
      });
    },
    generateRandomEmail() {
